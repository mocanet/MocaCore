...
''' <history> 
''' </history> 
Public Class UserRowPosatgreSql
    Implements System.ComponentModel.INotifyPropertyChanged

#Region " Declare "
    Shared _def As IUserDefinitionPosatgreSql
...
''' <history> 
''' </history> 
<Table("MocaCore.Test.My.MySettings.PostgreSQL", "mstUser")>
Public Interface IUserDefinitionPosatgreSql
