...
<TestClass()>
Public Class OleDbOraAccessHelperTest
	Inherits MyTestBase

	Private _helper As Moca.Db.Helper.OleDbOraAccessHelper
...
#Region "追加のテスト属性"
	...
	Public Sub MyTestInitialize()
		Dim dbms As New Moca.Db.Dbms("MocaCore.Test.My.MySettings.OraOle")
		Dim dba As New Moca.Db.DbAccess(dbms)
		_helper = New Moca.Db.Helper.OleDbOraAccessHelper(dba)
	End Sub
