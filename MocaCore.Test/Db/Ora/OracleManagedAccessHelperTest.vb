...
Public Class OracleManagedAccessHelperTest
	...
	Private _helper As Moca.Db.Helper.OracleManagedAccessHelper
...
#Region "追加のテスト属性"
	...
	Public Sub MyTestInitialize()
		Dim dbms As New Moca.Db.Dbms("MocaCore.Test.My.MySettings.OraManaged")
		Dim dba As New Moca.Db.DbAccess(dbms)
		_helper = New Moca.Db.Helper.OracleManagedAccessHelper(dba)
	End Sub
