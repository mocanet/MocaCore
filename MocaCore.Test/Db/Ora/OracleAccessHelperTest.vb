...
Public Class OracleAccessHelperTest
	...
	Private _helper As Moca.Db.Helper.OracleAccessHelper
...
#Region "追加のテスト属性"
	...
	Public Sub MyTestInitialize()
		Dim dbms As New Moca.Db.Dbms("MocaCore.Test.My.MySettings.Ora")
		Dim dba As New Moca.Db.DbAccess(dbms)
		_helper = New Moca.Db.Helper.OracleAccessHelper(dba)
	End Sub
